...
// --- Mock Data ---
const BANNERS = [
  { id: '1', image: require('../../../assets/banner1.png'), storeId: 'sharma-123' },
  { id: '2', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=600', storeId: 'verma-456' },
];
...
const FEATURED_STORES = [
  { 
    ...
    rating: '4.8', 
    distance: '0.5 km',
    image: 'https://images.unsplash.com/photo-1534723452862-4c874018d66d?q=80&w=300' 
  },
  { 
    id: '2', 
  ...
  { 
    ...
    rating: '4.9', 
    distance: '2.4 km',
    image: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?q=80&w=300' 
  },
];
...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.sectionContainer}>
        <View style={styles.sectionHeader}>
          <View>
            ...
            <Text style={styles.sectionSubtitle}>Discover local gems in your area</Text>
          </View>
          <TouchableOpacity onPress={() => router.push('/bazar')}>
              ...
              <View style={styles.cardContent}>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <View style={styles.footerInfo}>
                    ...
                    <Text style={[styles.footerLabel, { fontWeight: 'bold', color: colors.text.primary }]}>
                      {item.rating}
                    </Text>
                  </View>
                </View>
      ...
      <View style={styles.sectionContainer}>
        <Text style={[styles.sectionTitle, { paddingHorizontal: spacing.md }]}>Trending Now</Text>
